<template>
  <div class="top-list mtop-60">
          ...
          <ul class="mleft-30">
            ...
            >
              <span class="mleft-12 text-hidden">{{ index + 1 }}</span>
							...
							<span v-if="music.alia[0] && !isPhone" class="mleft-10 buchong text-hidden">({{music.alia[0]}})</span>
							<span v-else-if="music.tns && !isPhone" class="mleft-10 buchong text-hidden">({{music.tns[0]}})</span>			
    ...
    <!-- 全球榜区域 -->
    <div class="global-list mtop-50" v-if="guanfangList.length == 4">
