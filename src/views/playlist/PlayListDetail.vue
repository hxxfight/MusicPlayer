      ...
      <template>
        <div>
            ...
            <div class="detail-desc-info">
              ...
              <div class="font-14">
                ...
                <label for="check" class="check-in">
									<i class="iconfont icon-zhankai"></i></label>
                <label for="check" class="check-out">
									<i class="iconfont icon-shouqi"></i></label>
              </div>
            </div>
          </div>
          <!-- 歌单列表 -->
          <div class="detail-head">
            <TabMenu
              :menuList="['歌曲列表', `评论(${info.commentCount})`]"
...
import { getPlayListDetail, setPlaylistSub } from '@/api/api_playlist'
