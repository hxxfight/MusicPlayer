  ...
  <div class="artist-detail mtop-20">
    <div class="artist-info">
      ...
      <div class="info">
        ...
        <div class="info-btn">
          <button class="btn btn-white" @click="subArtist">
    ...
    <div v-show="tabIndex === 2">
      ...
      <template v-else>
        <div class="mtop-30 " v-for="text in introduction" :key="text.ti">
...
export default {
  ...
  components: { 
		AlbumList, TopFiftyList, MvList, ImgList, TabMenu 
	},
  data() {
    return {
      artistInfo: {
  ...
  methods: {
    ...
    async getIntroduction() {
      ...
      if (res.code !== 200) return
      console.log('歌手详情',res.introduction)
